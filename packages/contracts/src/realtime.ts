...
export type TopicKind = "events" | "terminal" | "presence";

export interface ParsedTopic {
  kind: TopicKind;
  /** companyId for events/presence, terminal sessionId for terminal. */
  id: string;
}

const TOPIC_PATTERN = /^(events|terminal|presence):([0-9a-f-]{36})$/;
